...
urlpatterns = patterns('',
    ...
    url(r'^twitter/$', redirect_to, {'url': 'http://twitter.com/libercopy'}, name='twitter'),
    url(r'^facebook/$', redirect_to, {'url': 'https://www.facebook.com/pages/LiberCopy/182462775103017'}, name='facebook'),
)
