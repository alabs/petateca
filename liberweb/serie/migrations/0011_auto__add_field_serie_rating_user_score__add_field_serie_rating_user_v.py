...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Serie.finished'
        db.alter_column('serie_serie', 'finished', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'ImageActor.is_poster'
        db.alter_column('serie_imageactor', 'is_poster', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'ImageSerie.is_poster'
        db.alter_column('serie_imageserie', 'is_poster', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Serie.finished'
        db.alter_column('serie_serie', 'finished', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ImageActor.is_poster'
        db.alter_column('serie_imageactor', 'is_poster', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ImageSerie.is_poster'
        db.alter_column('serie_imageserie', 'is_poster', self.gf('django.db.models.fields.BooleanField')())
