...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Languages', fields ['iso_code', 'country']
        db.create_unique('serie_languages', ['iso_code', 'country'])

    def backwards(self, orm):
        
        # Removing unique constraint on 'Languages', fields ['iso_code', 'country']
        db.delete_unique('serie_languages', ['iso_code', 'country'])
