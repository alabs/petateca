...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Episode.slug_title'
        db.delete_column('serie_episode', 'slug_title')


    def backwards(self, orm):
        
        # Adding field 'Episode.slug_title'
        db.add_column('serie_episode', 'slug_title', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)
