...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ImageEpisode'
        db.create_table('serie_imageepisode', (
            ('src', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['serie.Episode'])),
            ('creator', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('is_poster', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('serie', ['ImageEpisode'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ImageEpisode'
        db.delete_table('serie_imageepisode')
