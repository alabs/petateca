...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Episode', fields ['slug_title']
        db.create_unique('serie_episode', ['slug_title'])

        # Adding unique constraint on 'Serie', fields ['slug_name']
        db.create_unique('serie_serie', ['slug_name'])

        # Adding unique constraint on 'Genre', fields ['slug_name']
        db.create_unique('serie_genre', ['slug_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Genre', fields ['slug_name']
        db.delete_unique('serie_genre', ['slug_name'])

        # Removing unique constraint on 'Serie', fields ['slug_name']
        db.delete_unique('serie_serie', ['slug_name'])

        # Removing unique constraint on 'Episode', fields ['slug_title']
        db.delete_unique('serie_episode', ['slug_title'])
