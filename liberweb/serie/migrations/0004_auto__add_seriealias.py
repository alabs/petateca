...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SerieAlias'
        db.create_table('serie_seriealias', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('serie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='aliases', to=orm['serie.Serie'])),
        ))
        db.send_create_signal('serie', ['SerieAlias'])


    def backwards(self, orm):
        
        # Deleting model 'SerieAlias'
        db.delete_table('serie_seriealias')
