...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Author.book'
        db.delete_column('book_author', 'book_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Author.book'
        raise RuntimeError("Cannot reverse this migration. 'Author.book' and its values cannot be restored.")
