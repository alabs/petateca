...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field favorite_books on 'UserProfile'
        db.create_table('userdata_userprofile_favorite_books', (
        ...
        db.create_unique('userdata_userprofile_favorite_books', ['userprofile_id', 'book_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field favorite_books on 'UserProfile'
        db.delete_table('userdata_userprofile_favorite_books')
    ...
    models = {
        ...
        'userdata.userprofile': {
            ...
            'favorite_books': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'favorite_book'", 'symmetrical': 'False', 'to': "orm['book.Book']"}),
