...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserToInvite.date'
        db.alter_column('userdata_usertoinvite', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserToInvite.date'
        db.alter_column('userdata_usertoinvite', 'date', self.gf('django.db.models.fields.DateTimeField')())
