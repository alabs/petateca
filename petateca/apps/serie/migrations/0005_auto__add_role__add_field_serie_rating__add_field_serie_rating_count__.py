...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('serie_role', (
            ...
            ('serie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serie.Serie'])),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serie.Actor'])),
            ('sortorder', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('serie', ['Role'])
        ...
        # Adding field 'Serie.finished'
        db.add_column('serie_serie', 'finished', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Serie.finished'
        db.delete_column('serie_serie', 'finished')
