...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LinkSeason.episode'
    ...
    def backwards(self, orm):
        ...
        # Adding field 'LinkSeason.episode'
        db.add_column('serie_linkseason', 'episode', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='links', to=orm['serie.Season']), keep_default=False)

        # Deleting field 'LinkSeason.season'
        db.delete_column('serie_linkseason', 'season_id')
