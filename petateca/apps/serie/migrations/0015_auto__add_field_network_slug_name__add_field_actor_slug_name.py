...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Network.slug_name'
        db.add_column('serie_network', 'slug_name', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50, db_index=True), keep_default=False)

        # Adding field 'Actor.slug_name'
        db.add_column('serie_actor', 'slug_name', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Network.slug_name'
        db.delete_column('serie_network', 'slug_name')

        # Deleting field 'Actor.slug_name'
        db.delete_column('serie_actor', 'slug_name')
