...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LinkSeason.check_date'
        db.add_column('serie_linkseason', 'check_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LinkSeason.check_date'
        db.delete_column('serie_linkseason', 'check_date')
