...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'LinkSeason.user' to match new field type.
        db.rename_column('serie_linkseason', 'user', 'user_id')
        # Changing field 'LinkSeason.user'
        db.alter_column('serie_linkseason', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Adding index on 'LinkSeason', fields ['user']
        db.create_index('serie_linkseason', ['user_id'])


    def backwards(self, orm):
        
        # Removing index on 'LinkSeason', fields ['user']
        db.delete_index('serie_linkseason', ['user_id'])

        # Renaming column for 'LinkSeason.user' to match new field type.
        db.rename_column('serie_linkseason', 'user_id', 'user')
        # Changing field 'LinkSeason.user'
        db.alter_column('serie_linkseason', 'user', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
