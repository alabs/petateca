...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.title_en'
        db.alter_column('serie_episode', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Episode.title_es'
        db.alter_column('serie_episode', 'title_es', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Serie.name_es'
        db.alter_column('serie_serie', 'name_es', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Serie.description_en'
        db.alter_column('serie_serie', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Serie.description_es'
        db.alter_column('serie_serie', 'description_es', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Serie.name_en'
        db.alter_column('serie_serie', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Genre.name_en'
        db.alter_column('serie_genre', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Genre.name_es'
        db.alter_column('serie_genre', 'name_es', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Episode.title_en'
        raise RuntimeError("Cannot reverse this migration. 'Episode.title_en' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Episode.title_es'
        raise RuntimeError("Cannot reverse this migration. 'Episode.title_es' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Serie.name_es'
        raise RuntimeError("Cannot reverse this migration. 'Serie.name_es' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Serie.description_en'
        raise RuntimeError("Cannot reverse this migration. 'Serie.description_en' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Serie.description_es'
        raise RuntimeError("Cannot reverse this migration. 'Serie.description_es' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Serie.name_en'
        raise RuntimeError("Cannot reverse this migration. 'Serie.name_en' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Genre.name_en'
        raise RuntimeError("Cannot reverse this migration. 'Genre.name_en' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Genre.name_es'
        raise RuntimeError("Cannot reverse this migration. 'Genre.name_es' and its values cannot be restored.")
