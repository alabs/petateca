...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Link.is_active'
        db.add_column('serie_link', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Link.is_active'
        db.delete_column('serie_link', 'is_active')
