...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LinkSeason.is_active'
        db.add_column('serie_linkseason', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LinkSeason.is_active'
        db.delete_column('serie_linkseason', 'is_active')
