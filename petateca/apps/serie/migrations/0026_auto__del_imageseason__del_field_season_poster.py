...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('serie_season', 'poster', self.gf('django.db.models.fields.related.OneToOneField')(related_name='poster_of', unique=True, null=True, to=orm['serie.ImageSeason'], blank=True), keep_default=False)
