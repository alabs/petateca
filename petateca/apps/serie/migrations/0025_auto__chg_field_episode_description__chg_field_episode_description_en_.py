...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Episode.description'
        db.alter_column('serie_episode', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Episode.description_en'
        db.alter_column('serie_episode', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Episode.description_es'
        db.alter_column('serie_episode', 'description_es', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Episode.description'
        db.alter_column('serie_episode', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Episode.description_en'
        db.alter_column('serie_episode', 'description_en', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Episode.description_es'
        db.alter_column('serie_episode', 'description_es', self.gf('django.db.models.fields.TextField')(default=''))
