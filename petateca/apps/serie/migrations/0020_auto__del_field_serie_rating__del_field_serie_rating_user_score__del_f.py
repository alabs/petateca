...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Serie.rating'
        db.delete_column('serie_serie', 'rating')

        # Deleting field 'Serie.rating_user_score'
        db.delete_column('serie_serie', 'rating_user_score')

        # Deleting field 'Serie.rating_user_votes'
        db.delete_column('serie_serie', 'rating_user_votes')

        # Deleting field 'Serie.rating_count'
        db.delete_column('serie_serie', 'rating_count')

        # Adding field 'Serie.rating_votes'
        db.add_column('serie_serie', 'rating_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Serie.rating_score'
        db.add_column('serie_serie', 'rating_score', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Serie.rating'
        db.add_column('serie_serie', 'rating', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Serie.rating_user_score'
        db.add_column('serie_serie', 'rating_user_score', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Serie.rating_user_votes'
        db.add_column('serie_serie', 'rating_user_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Serie.rating_count'
        db.add_column('serie_serie', 'rating_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Serie.rating_votes'
        db.delete_column('serie_serie', 'rating_votes')

        # Deleting field 'Serie.rating_score'
        db.delete_column('serie_serie', 'rating_score')
