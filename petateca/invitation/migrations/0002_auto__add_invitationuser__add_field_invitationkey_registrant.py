...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvitationKey.registrant'
        db.add_column('invitation_invitationkey', 'registrant', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invitations_used', null=True, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InvitationKey.registrant'
        db.delete_column('invitation_invitationkey', 'registrant_id')
