...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Languages', fields ['iso_code']
        db.delete_unique('serie_languages', ['iso_code'])

        # Adding unique constraint on 'Link', fields ['url']
        db.create_unique('serie_link', ['url'])

        # Adding field 'Languages.country'
        db.add_column('serie_languages', 'country', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Link', fields ['url']
        db.delete_unique('serie_link', ['url'])

        # Deleting field 'Languages.country'
        db.delete_column('serie_languages', 'country')

        # Adding unique constraint on 'Languages', fields ['iso_code']
        db.create_unique('serie_languages', ['iso_code'])
