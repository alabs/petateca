...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Role', fields ['serie', 'role', 'actor']
        db.create_unique('serie_role', ['serie_id', 'role', 'actor_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Role', fields ['serie', 'role', 'actor']
        db.delete_unique('serie_role', ['serie_id', 'role', 'actor_id'])
