...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Episode.serie'
        db.delete_column('serie_episode', 'serie_id')

        # Renaming column for 'Episode.season' to match new field type.
        db.rename_column('serie_episode', 'season', 'season_id')
        # Changing field 'Episode.season'
        db.alter_column('serie_episode', 'season_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serie.Season']))

        # Adding index on 'Episode', fields ['season']
        db.create_index('serie_episode', ['season_id'])


    def backwards(self, orm):
        
        # Removing index on 'Episode', fields ['season']
        db.delete_index('serie_episode', ['season_id'])

        # Adding field 'Episode.serie'
        db.add_column('serie_episode', 'serie', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='episodes', to=orm['serie.Season']), keep_default=False)

        # Renaming column for 'Episode.season' to match new field type.
        db.rename_column('serie_episode', 'season_id', 'season')
        # Changing field 'Episode.season'
        db.alter_column('serie_episode', 'season', self.gf('django.db.models.fields.IntegerField')())
