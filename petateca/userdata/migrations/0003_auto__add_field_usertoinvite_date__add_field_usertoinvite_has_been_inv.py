...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserToInvite.date'
        db.add_column('userdata_usertoinvite', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'UserToInvite.has_been_invited'
        db.add_column('userdata_usertoinvite', 'has_been_invited', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserToInvite.date'
        db.delete_column('userdata_usertoinvite', 'date')

        # Deleting field 'UserToInvite.has_been_invited'
        db.delete_column('userdata_usertoinvite', 'has_been_invited')
