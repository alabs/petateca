...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserToInvite'
        db.create_table('userdata_usertoinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mail', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('userdata', ['UserToInvite'])


    def backwards(self, orm):
        
        # Deleting model 'UserToInvite'
        db.delete_table('userdata_usertoinvite')
